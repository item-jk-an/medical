...
<script type="text/javascript">
    $(function (){
        ...
        $("#infoFlowTable").bootstrapTable({
            url:"<%=request.getContextPath()%>/flow/queryInfo1Flow.do",
            method:"post",
            ...
            columns:[
                ...
                {field:'infoId',title:'info1ID', class:'warning',width:100},
                {field:'infoName',title:'info1名称', class:'success',width:100},
                {field:'infoId',title:'查看info1详情', class:'success',width:100,
                    formatter:function(value,row,index){   //  格式化  当前单元格内容
...
<script type="text/javascript">
    ...
    function chakan(id){
        dialog("<%=request.getContextPath()%>/flow/queryInfo1FlowById.do?info1Id="+id,"查看详情");
    }

    function yes(id){
        $.ajax({
            url:"<%=request.getContextPath()%>/flow/updateflowInfo1ShenById.do",
            type:"get",
            data:{"id":id},
            success:function(){
                bootbox.alert('审核通过');
    ...
    function no(id){
        $.ajax({
            url:"<%=request.getContextPath()%>/flow/updateflowInfo1ShenNOById.do",
            type:"get",
            data:{"id":id},
            success:function(){
